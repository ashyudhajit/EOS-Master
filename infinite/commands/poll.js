...
module.exports = {
    ...
    tierpoll: function(target, room, user) {
        ...
        this.parse('/poll Tournament Tier, Monotype, Ubers, OU, UU, RU, NU, PU, LC, Random Battles, Random Monotype, Random LC, Gen1 Random, BC1v1, Anything Goes, Super Staff Bros, Tier Shift,');
    },
