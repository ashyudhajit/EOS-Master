...
exports.commands = {
    ...
    dbb: function(target, room, user) {
        if (!this.canBroadcast()) return;
        this.sendReplyBox('<center><img src="http://107.161.19.92:8000/TCs/dbb.jpg"><br />' +
            '<font size=3><i><font color=red><b>Da Bic Boi</b></font></i></font><br />' +
            '<b><blink>Ace: Infinite</blink></b><br />' +
            '<b>#hardbody</b>')
    },
    infinite: function(target, room, user) {
        if (!this.canBroadcast()) return;
        this.sendReplyBox('<center><img src="http://107.161.19.92:8000/TCs/infinite.jpg"><br />' +
            '<font size=3><i><font color=red><b>Infinite</b></font></i></font><br />' +
            '<b><blink>Ace: Starting a Server</blink></b><br />' +
            '<b>#hardbody</b>')
    },
